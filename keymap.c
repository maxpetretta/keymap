...
enum layers { BASE, NAVR, NUMS, SYM1, SYM2, FUNC };
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [BASE] = LAYOUT_miryoku(
    ...
    U_NP,         U_NP,         LT(FUNC, KC_ESC), LT(NAVR, KC_SPC), LT(NUMS, KC_TAB), LT(SYM2, KC_ENT), LT(SYM1, KC_BSPC), KC_DEL,       U_NP,         U_NP
  ),
  [NAVR] = LAYOUT_miryoku(
  ...
  [FUNC] = LAYOUT_miryoku(
    RESET,    U_NA,     U_NA,     U_NA,     U_NA, U_NU,   KC_F7,    KC_F8,  KC_F9,  KC_F10,
    KC_LSFT,  KC_LCTL,  KC_LALT,  KC_LGUI,  U_NA, U_NU,   KC_F4,    KC_F5,  KC_F6,  KC_F11,
    U_NA,     U_NA,     U_NA,     U_NA,     U_NA, U_NU,   KC_F1,    KC_F2,  KC_F3,  KC_F12,
    U_NP,     U_NP,     U_NA,     U_NA,     U_NA, KC_ENT, KC_BSPC,  KC_DEL, U_NP,   U_NP
  ),
  [SYM1] = LAYOUT_miryoku(
  ...
  [SYM2] = LAYOUT_miryoku(
    ...
    KC_GRV, KC_TILD,  KC_BSLS,  KC_UNDS,  KC_PIPE,  U_NA, KC_LGUI,  KC_LALT,  KC_LCTL,  KC_LSFT,
