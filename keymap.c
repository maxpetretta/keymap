...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [BASE] = LAYOUT_planck_grid(
    ...
    U_NP,         U_NP,         U_NP,         KC_ESC,       LT(NAVR, KC_SPC), KC_TAB, KC_ENT, LT(NUMP, KC_BSPC), KC_DEL,       U_NP,         U_NP,         U_NP
  ),
  [NAVR] = LAYOUT_planck_grid(
    LGUI_T(KC_1), LGUI_T(KC_2), LGUI_T(KC_3), LGUI_T(KC_4), LGUI_T(KC_5), U_NA, U_NA,   KC_CAPS,  KC_HOME, KC_PGDN, KC_PGUP, KC_END,
